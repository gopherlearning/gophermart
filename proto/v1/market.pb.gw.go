...
func request_GopherMarket_Register_0(ctx context.Context, marshaler runtime.Marshaler, client GopherMarketClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_GopherMarket_Register_0(ctx context.Context, marshaler runtime.Marshaler, server GopherMarketServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq AuthRequest
	var metadata runtime.ServerMetadata
...
func RegisterGopherMarketHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GopherMarketServer) error {
	...
	mux.Handle("POST", pattern_GopherMarket_Register_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/gopher.market.v1.GopherMarket/Register", runtime.WithHTTPPathPattern("/gopher.market.v1.GopherMarket/Register"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_GopherMarket_Register_0(ctx, inboundMarshaler, server, req, pathParams)
		...
		forward_GopherMarket_Register_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterGopherMarketHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GopherMarketClient) error {
	...
	mux.Handle("POST", pattern_GopherMarket_Register_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/gopher.market.v1.GopherMarket/Register", runtime.WithHTTPPathPattern("/gopher.market.v1.GopherMarket/Register"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_GopherMarket_Register_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_GopherMarket_Register_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"gopher.market.v1.GopherMarket", "Register"}, ""))
)

var (
	forward_GopherMarket_Register_0 = runtime.ForwardResponseMessage
)
